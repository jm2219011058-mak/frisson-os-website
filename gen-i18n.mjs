...
const O = {
  ...
  'cities.hero2': [`Begin with a “More than Residence” — <b style="font-size:1.14em;">the Zahir Sky Atelier</b>, a living space designed to respond to human emotions.`, `从建造一座能回应人类情感的「More than Residence」开始——<b style="font-size:1.1em;">扎希尔观星塔</b>。`],
