...
const O = {
  ...
  'lv.lead': [`The way you eat, move and rest leaves a trace in every room. Sona's Vitality Agentic Model reads it as your biological age &mdash; and the space works quietly and without pause to turn it younger.`, `你的饮食、行动与睡眠，都会在每个空间留下痕迹。Sona's Vitality Agentic Model 将它读作你的生物年龄——空间安静且不间断地运作，让它逐渐变得更年轻。`],
  'lv.read.k': [`Read`, `共情`],
