...
const O = {
  ...
  '2.13': [`Into our work we graft <b>the aesthetic bloodline of Europe's four great Renaissance houses</b> — Medici, Cavendish, Palmela, Montmorency — and render it in a contemporary language of building.`, `我们植入欧洲文艺复兴四大家族：美第奇（Medici）、卡文迪什（Cavendish）、帕尔梅拉（Palmela）、蒙莫朗西（Montmorency）的美学基因,并把它们转译为当代的建造语言。`],
