...
<p class="st-p">谢谢你，Dav。谢谢你，HOPO。还要感谢所有在 FRISSON 早期就愿意分享、交流、与我们并肩前行的人们。</p>`
  ...
  'zahir.p5': [`Space Healing Your Body.</p><p class="zahir-body">From our first residence, FRISSON begins building a new global living network — where Space, Art, Intelligence, and Soul converge.</p><p class="zahir-body">Zahir Sky Atelier is the first expression of the FRISSON vision: a living landmark designed to inspire, connect, and evolve with those who inhabit it.</p><p class="zahir-body">Inspired by the cultural significance of places such as the Pitti Palace in Florence — where art, ideas, and human ambition converged — FRISSON creates contemporary landmarks for a new era of living.</p><p class="zahir-body">Through Eastern philosophy, timeless aesthetics, and <b>Sona Bio-AI OS — an intelligent layer that learns from human rhythms and adapts the living environment accordingly</b> — we create spaces that cultivate beauty, restore balance, and deepen the human experience.`, `空间疗愈你的身体。</p><p class="zahir-body">从第一座寓所开始,FRISSON 着手构建一张全新的全球居住网络——让空间、艺术、智能与灵魂在此交汇。</p><p class="zahir-body">扎希尔观星塔是 FRISSON 愿景的首个呈现:一座旨在启发、连接并与栖居其中的人共同生长的生活地标。</p><p class="zahir-body">灵感源自如佛罗伦萨皮蒂宫这般具有文化意义的场所——艺术、思想与人类雄心曾在那里交汇——FRISSON 为一个全新的生活时代创造当代地标。</p><p class="zahir-body">透过东方哲学、恒久美学,以及 <b>Sona Bio-AI OS——一层能从人的节律中学习、并据此调适居住环境的智能</b>——我们创造滋养美、恢复平衡、深化人类体验的空间。`],
