...
const O = {
  ...
  'cities.hero2': [`It begins with building a “<b>More than Residence</b>” that <b style="font-size:1.14em;">responds to human emotions</b>—<b style="font-size:1.1em;">Zahir Sky Atelier</b>.`, `从建造一座能<b style="font-size:1.14em;">回应人类情感</b>的「不止于此」开始——<b style="font-size:1.1em;">扎希尔观星塔</b>。`],
